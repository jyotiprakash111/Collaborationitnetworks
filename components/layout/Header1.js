            ...
            <header className={`main-header header-style-one ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`} >
                    ...
                    <div className="inner-container">
                        <div className="top-left">
                            <ul className="list-style-one">
                                <li><i className="fa fa-envelope" /> <Link href="mailto:info@collabitnetworks.com">info@collabitnetworks.com</Link></li>
                                <li><i className="fa fa-map-marker" /> B1/H3,Mohan Co-operative Industrial Area, New Delhi, Delhi. India - 110044</li>
                            </ul>
                        </div>
                ...
                <div className="header-lower">
                    <div className="main-box">
                        <div className="logo-box">
                            <div className="logo"><Link href="/"><Image src={LogoWhite} alt='Collaboration IT Networks' title='Collaboration IT Networks' /></Link></div>
                        </div>
                        <div className="nav-outer">
                            ...
                            <div className="outer-box">
                                ...
                                <Link href="tel:+92(8800)9806" className="info-btn">
                                    ...
                                    <small>Call Anytime</small><br /> +91 836 884 1232
                                </Link>
                        ...
                        <ul className="contact-list-one">
                            ...
                            <li>
                                <div className="contact-info-box">
                                    ...
                                    <Link href="mailto:help@company.com">help@collaborationitnetworks.com</Link>
                                </div>
                            </li>
                            <li>
                                <div className="contact-info-box">
                ...
                <div className={`sticky-header ${scroll ? "fixed-header animated slideInDown" : ""}`}>
                    <div className="auto-container">
                        <div className="inner-container">
                            <div className="logo">
                                <Link href="/" title><Image akt="Collaboration IT Nrtworks" src={LogoDark} title='Oitech' /></Link>
                            </div>
                            <div className="nav-outer">
